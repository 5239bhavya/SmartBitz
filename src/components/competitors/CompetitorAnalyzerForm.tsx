            ...
            {analysis && !isLoading && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {/* Strengths */}
                        <Card variant="glass" className="border-border/50 shadow-sm border-t-4 border-t-emerald-500">
                        ...
                        {/* Weaknesses */}
                        <Card variant="glass" className="border-border/50 shadow-sm border-t-4 border-t-rose-500">
                            <CardHeader className="pb-2">
                        ...
                        {/* Opportunities */}
                        <Card variant="glass" className="border-border/50 shadow-sm border-t-4 border-t-blue-500">
                            <CardHeader className="pb-2">
                        ...
                        {/* Threats */}
                        <Card variant="glass" className="border-border/50 shadow-sm border-t-4 border-t-amber-500">
                            <CardHeader className="pb-2">
