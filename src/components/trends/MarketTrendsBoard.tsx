        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                {trends.key_insights.map((insight, idx) => (
                    <Card variant="glass" key={idx} className="bg-primary/5 border-primary/20 shadow-sm">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
                {trends.trending_categories.map((trend, idx) => (
                    <Card variant="glass" key={idx} className="border-border/50 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
