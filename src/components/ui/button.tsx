  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0 font-medium",
        "hero-outline":
        ...
        success:
          "bg-success text-success-foreground hover:bg-success/90 shadow-sm hover:shadow active:scale-[0.98]",
        glass:
          "glass text-foreground hover:glass-strong shadow-sm hover:shadow active:scale-[0.98]",
      },
      size: {
